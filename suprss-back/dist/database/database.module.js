        ...
        imports: [
            typeorm_1.TypeOrmModule.forRootAsync({
                ...
                useFactory: (configService) => ({
                    ...
                    entities: [user_entity_1.User, feeds_entity_1.Feed, article_entity_1.Article, collection_entity_1.Collection, collection_members_1.CollectionMember, comment_entity_1.Comment, message_entity_1.Message],
