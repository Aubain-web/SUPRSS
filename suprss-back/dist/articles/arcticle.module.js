...
exports.ArticlesModule = ArticlesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([article_entity_1.Article]), collection_module_1.CollectionsModule],
        controllers: [article_controller_1.ArticlesController],
        providers: [article_service_1.ArticlesService],
        exports: [article_service_1.ArticlesService],
    })
], ArticlesModule);
//# sourceMappingURL=arcticle.module.js.map